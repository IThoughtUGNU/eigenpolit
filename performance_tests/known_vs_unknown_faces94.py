...
from datasetpaths import faces94, faces94_own_classes, faces94_complement, faces94_ALL_classes
...
if __name__ == "__main__":
    ...
    model = DatasetModel([faces94, faces94_complement])
    model = model.labeledByFolderOfFiles(faces94_ALL_classes)
    m,n = model.getDim()
