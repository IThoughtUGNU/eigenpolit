...
if __name__ == "__main__":
    ...
    import numpy as np
    import cv2
    from datasetpaths import polit100, polit100_own_classes, polit100lbp, polit100_complement, polit100_all_classes
...
#           Select 80/20 or 90/10 randomly to build training set and test set.
        ...
        cv2.imshow("Test image (permutated)", cv2.resize(X_test_p[23].reshape(100, 100),(200,200)))
        cv2.waitKey(0)
